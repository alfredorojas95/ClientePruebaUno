...
public class ServicioMatriculaServiceLocator extends org.apache.axis.client.Service implements servicios.ServicioMatriculaService {
    ...
    private java.lang.String ServicioMatricula_address = "http://localhost:8080/ServicioUniver/services/ServicioMatricula";
    ...
    public servicios.ServicioMatricula getServicioMatricula(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servicios.ServicioMatriculaSoapBindingStub _stub = new servicios.ServicioMatriculaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicios.ServicioMatricula.class.isAssignableFrom(serviceEndpointInterface)) {
                servicios.ServicioMatriculaSoapBindingStub _stub = new servicios.ServicioMatriculaSoapBindingStub(new java.net.URL(ServicioMatricula_address), this);
                _stub.setPortName(getServicioMatriculaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicios", "ServicioMatriculaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicios", "ServicioMatricula"));
        }
